...
export default function BusinessesError({
  ...
  return (
    <div className="mx-auto max-w-lg space-y-4 rounded-xl border border-red-200 bg-red-50 p-6">
      <h1 className="text-lg font-semibold text-red-900">Could not load businesses</h1>
      <p className="text-sm text-red-800">{error.message || "Unknown server error."}</p>
      {error.digest ? (
      ...
      <div className="space-y-2 text-sm text-red-900">
        ...
        <ul className="list-disc space-y-1 pl-5">
          <li>Run SQL migrations 000, 002, 003 in Supabase</li>
