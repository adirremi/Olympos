...
import { buildReminderMessage, MorningRow } from "../_shared/workout-message.ts";

const INTENT = "morning_reminder";
...
Deno.serve(async (request) => {
  ...
  const { data, error } = await supabase.rpc("get_whatsapp_unfinished_reminders");
